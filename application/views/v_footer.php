		...
		<div class="row">
			<div class="col-sm-6">
				<div class="footer-content">
					<h2>KELURAHAN</h2>					
					<legend></legend>
					<p><h4>Sistem Informasi Kelurahan</h4></p>
					<div class="row">
						<div class="col-md-6 col-sm-12 col-xs-12">
							<ul class="list-icons">
							<li><i class="fa fa-map-marker"></i>Kantor Kelurahan</li>
							<li><i class="fa fa"></i>JL. </li>
							<li><i class="fa "></i>Kec.<br></li>	
							<li><i class="fa fa-map-marker"></i>Kantor Kelurahan</li>
							<li><i class="fa fa"></i>JL. </li>
							<li><i class="fa "></i>Kec.<br></li>						
						</ul>
						...
						<div class="col-md-6 col-sm-12 col-xs-12">
						<ul class="list-icons">
						<li><i class="fa fa-phone pr-10"></i> 021</li>
						<li><i class="fa fa-envelope-o pr-10"></i> kelurahan@google.com</li>
						<li><i class="fa fa-mobile-phone pr-10"></i> +62</li>
						</ul>
							<ul class="social-links circle">
							<li class="link"><a target="_blank" href="https://kelurahan.com" title="Website" rel="noopener noreferrer"><i class="fa fa-link"></i></a></li>
							<li class="facebook"><a target="_blank" href="https://facebook.com/kelurahan" title="Facebook"><i class="fa fa-facebook"></i></a></li>
