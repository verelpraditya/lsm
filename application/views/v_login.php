...
<body style="background-image:url(<?php echo base_url(); ?>images/cn.jpg);background-size:cover;">
            ...
            <div class="col-md-4 col-md-offset-4">
                <div class="login-panel panel ">
                    ...
                    <div class="panel-heading">
						<img src="<?php echo base_url(); ?>assetku/img/logo_kel_cipayung.png" class="img-responsive"> 						
                    </div>
					...
					<div class="panel-footer">
						<span align="center">&reg; SIK 2023 | &copy; T3@<span>
					</div>
                </div>
            </div>
        </div>
