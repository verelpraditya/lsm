...
<div class="navbar bg-warning sidebar" role="navigation">
						...
						<div id="pengelola_data_web" class="collapse">
							<ul id="" class="nav nav-pills nav-stacked nav-second-level ">
								...
								<li id="nav-sejarah" class="">
									<a href="<?php echo site_url('admin/c_sejarah/');?>">Sejarah Satgas</a>
								</li>
				...
				<!---------------------DROPDOWN 2--------------------------------------------------------------->
						...
						<li>
							<a href="<?php echo site_url('pustaka/c_perangkat/');?>" id="a-perangkat" class=""><i class="fa fa-star fa-fw"></i> Dewan Pengurus Satgas</a>							
						</li>
						<li>
