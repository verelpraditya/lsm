...
<head>
	...
	<!-- Datatables -->
	<link href="https://cdn.datatables.net/v/bs/dt-1.13.2/datatables.min.css" />
...
<body>
			...
			<div class="col-md-8">
				<div class="navbar-header">
					<a href=" <?php
						...
						<img src="<?php echo base_url(); ?>assetku/img/logo_kel_cipayung.png" style="float:left; height:fixed; width:30%; margin-top:2px; margin-bottom:2px;">
					</a>
				</div>
	...
	<!-- Alertify JavaScript -->
	<script src="https://cdn.datatables.net/v/bs/dt-1.13.2/datatables.min.js"></script>
