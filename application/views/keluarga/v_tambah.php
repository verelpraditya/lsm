...
<fieldset>
	...
	<div class="form-group">
		...
		<label class="col-md-3 control-label" for="is_sementara_keluarga">Status Anggota Sementara</label>
		<div class="col-md-9">
			<div class="radio">
	...
	<div class="form-group">
		<label class="col-md-3 control-label" for="no_kk">No Kartu Anggota*</label>
		<div class="col-md-9">
	...
	<div class="form-group">
		...
		<div class="col-md-4">
			...
			<?php $id = 'id="id_provinsi" name="id_provinsi" class="form-control input-md" required';
			echo form_dropdown('id_provinsi', $nama_provinsi, '', $id) ?>
	...
	<!-- Form KabKota -->
	<div class="form-group">
		<label class="col-md-1 control-label" for="kabupaten">Kab/Kota </label>
		<div class="col-md-4">
			<select class="form-control input-md" required name="kabupaten" id="kabupaten">
	...
	<!-- Form Kecamatan -->
	<div class="form-group">
		<label class="col-md-3 control-label" for="keca">Kecamatan</label>
		<div class="col-md-4">

			<select name="kecamatan" id="kecamatan" class="form-control input-md" required>
	...
	<!-- Form Desa -->
	<div class="form-group">
		<label class="col-md-1 control-label" for="desa">Desa </label>
		<div class="col-md-4">
			<select name="desa" id="desa" class="form-control input-md" required>
	...
	<div class="form-group">
		 <label class="col-md-3 control-label" for="is_pkh">Menerima Program Anggota Harapan</label>
        <div class="col-md-2">
         <div class="radio">
	...
	<div class="form-group">
		<label class="col-md-3 control-label" for="is_sementara_penduduk">Status Anggota Sementara</label>
		<div class="col-md-9">
			<div class="radio">
	...
	<!------------------------------------------
	<label class="col-md-0 control-label" for="="><h4>Hubungan Anggota</h4></label>
	<legend></legend>
   <div class="form-group">
    	 <label class="col-md-3 control-label" for="nama_ayah">Status Anggota </label>
        <div class="col-md-9">  
		<input class="form-control input-md" type="text" id="no_telp" size="30" value="Anggota" disabled>
		<span class="help-block"></span> 		
	</div>
	</div>	
   <div class="form-group">
...
<script>
	...
	$(document).ready(function() {
		...
		// $("#id_provinsi").change(function() {
		// 	var cek = document.getElementById("id_provinsi").value;

		// 	if (cek === "") {
		// 		document.getElementById("id_kabkota_sementara").style.display = 'block';
		// 		document.getElementById("id_kab_kota").style.display = 'none';
		...
		// 		$.ajax({
		// 			type: "POST",
		// 			url: "<?php echo site_url('datapenduduk/c_keluarga/getKabkota') ?>",
		// 			data: id_provinsi,
		// 			success: function(msg) {
		// 				document.getElementById("id_kabkota_sementara").style.display = 'none';

		// 				$('#lala_provinsi').html(msg);
		// 			}
		// 		});
		// 	}
		// });
		...
		// 	var cek = document.getElementById("id_kecamatan").value;
		// 	var nama = 'verel'
		// 	console.log(nama);
