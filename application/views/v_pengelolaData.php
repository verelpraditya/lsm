	...
	<div class="row">
		...
		<div class="col-md-12">
			<a href="<?php echo site_url('datapenduduk/c_keluarga/add');?>">
				<button type="button" class="btn btn-warning"><i class="fa fa-plus-square fa-fw"></i> Tambah Anggota</button>
			</a>
			<a href="<?php echo site_url('datapenduduk/c_keluarga/');?>">
				<button type="button" class="btn btn-warning"><i class="fa fa-list fa-fw"></i> Daftar Data Anggota</button>
			</a>			
		</div>
	</div>
	<br>
...
$(function () {
   ...
   $('#keluarga').highcharts({
        ...
        subtitle: {
            text: 'Berdasarkan Jenis Kelamin Ketua DPD'
        },
        xAxis: {
            categories: [
                'Ketua DPD'
