...
class M_keluarga extends CI_Model
{
	...
	// function get_kabkota_dinamic($id_provinsi)
	// {
	...
	// function get_kecamatan_dinamic($id_kab_kota)
	// {
	...
	// function get_desa_dinamic($id_kecamatan)
	// {
	...
	{
		$this->db->where('id_provinsi', $id_provinsi);
		$query = $this->db->get('ref_kab_kota');
		return $query->result();
	}
