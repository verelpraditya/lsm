...
class M_penduduk extends CI_Model
{
	...
	public function get_penduduk_flexigrid()
	{
		...
		$this->db->join('ref_provinsi', 'tbl_penduduk.id_provinsi=ref_provinsi.id_provinsi'); 				            // Provinsi
		$this->db->join('ref_kab_kota', 'tbl_penduduk.id_kab_kota=ref_kab_kota.id_kab_kota'); 							// ke tbl RW
		$this->db->join('ref_kecamatan', 'tbl_penduduk.id_kecamatan=ref_kecamatan.id_kecamatan'); 						// ke tbl DUSUN
		$this->db->join('ref_desa', 'tbl_penduduk.id_desa=ref_desa.id_desa'); 						// ke tbl DUSUN
	...
	function getDataPendudukByIdPenduduk($id_penduduk)
	{
		...
		ref_kecamatan.nama_kecamatan as nama_kecamatan,
		ref_kab_kota.nama_kab_kota as nama_kab_kota,
		...
		$this->db->join('ref_desa', 'tbl_penduduk.id_desa=ref_desa.id_desa', 'left'); 													// ke tbl RT
		$this->db->join('ref_kecamatan', 'tbl_penduduk.id_kecamatan=ref_kecamatan.id_kecamatan', 'left'); 													// ke tbl RW
		$this->db->join('ref_kab_kota', 'tbl_penduduk.id_kab_kota=ref_kab_kota.id_kab_kota', 'left'); 										// ke tbl DUSUN
		$this->db->join('ref_provinsi', 'tbl_penduduk.id_provinsi=ref_provinsi.id_provinsi', 'left'); 										// ke tbl DUSUN
		...
		$this->db->join('ref_difabilitas', 'tbl_penduduk.id_difabilitas=ref_difabilitas.id_difabilitas', 'left'); 				// ke tbl DIFABILITAS			// ke tbl KONTRASEPSI 
